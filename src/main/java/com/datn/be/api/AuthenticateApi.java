...
import com.datn.be.domain.constant.RoleConst;
import com.datn.be.domain.dto.ReqForgotPasswordDto;
import com.datn.be.domain.exception.AppException;
import com.datn.be.domain.model.CustomUserDetails;
import com.datn.be.domain.payload.LoginRequest;
import com.datn.be.domain.payload.LoginResponse;
import com.datn.be.jwt.JwtTokenProvider;
...
public class AuthenticateApi {
    ...
    public ResponseEntity<?> forgotPassword(@RequestBody ReqForgotPasswordDto reqForgotPasswordDto) throws MessagingException, UnsupportedEncodingException {
